...
IntanBehaviour.time = lfpTime; % time in seconds; % time in seconds
...
missIndex(1) = [];
IntanBehaviour.nMiss = length(missIndex)-1; % TODO: fix edge case where miss window exceeds recording time (due to slow kinetics)
