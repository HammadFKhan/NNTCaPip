function Cell_Map_Dice(AverageImage,Connected_ROI,ROIbases,NodeList,NodeSize,EdgeSize)
...
%     plot(centroids(i,1),centroids(i,2), 'r+', 'MarkerSize', 10, 'LineWidth', 2);
    ...
    radius = NodeSize; 
    centerX = centroids(NodeList(i),1);
    centerY = centroids(NodeList(i),2);
