...
[vectorized,sim_index] = cosine_similarity(Spikes(:,1:2000),bin);
[shufvectorized,shufsim_index] = cosine_similarity(Total_shuffled(:,1:2000),bin);
...
addpath('Figures');
figure('Name','DeltaF/F'); stack_plot(DeltaFoverF,0.8,8); 
